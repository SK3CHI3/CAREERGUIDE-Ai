...
const faqs = [
  ...
  {
    question: "Is CareerGuide AI free to use?",
    answer: "Yes! CareerGuide AI is completely free for all students. All features including AI assessments, career matching, PDF reports, and the full platform are available at no cost."
  },
  {
    question: "Do students need individual accounts?",
    answer: "Yes, each student creates their own account to track their progress, save assessments, and receive personalized career recommendations. The platform is free for all students to use."
  },
  {

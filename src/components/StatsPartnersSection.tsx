  ...
  return (
    <section className="relative pt-2 pb-12 lg:py-12">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Main Card Container */}
        <div className="bg-card/60 backdrop-blur-md rounded-3xl border border-card-border overflow-hidden shadow-card hover:shadow-elevated transition-shadow duration-500 min-h-[500px] flex flex-col">

          {/* Content Area - Left side text */}
          <div className="flex-1 p-8 md:p-12 flex flex-col justify-center">
            <div className="max-w-2xl">
              <h2 className="text-3xl md:text-5xl font-bold bg-gradient-text bg-clip-text text-transparent mb-4">
          ...
          <div className="p-8 md:p-12 flex justify-end">
            <div className="text-right space-y-4 max-w-md">
              <h3 className="text-xl md:text-2xl font-bold text-foreground">Want to help shape our future?</h3>
              <p className="text-foreground-muted">Collaborate with CareerGuide AI to expand career guidance for students nationwide.</p>
              <Button
